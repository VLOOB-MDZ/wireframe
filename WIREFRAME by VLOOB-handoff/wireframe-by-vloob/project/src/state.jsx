...
const FONT_LIST = Object.keys(CANVAS_FONTS);

const WEIGHTS = { Light: 300, Regular: 400, Medium: 500, Bold: 700, Black: 900 };

const COLOR_PRESETS = ['#ffffff','#000000','#f5c518','#ff4d2e','#2ee6a8','#3b82f6','#a855f7','#ff7ab8',
                       '#0c0c0c','#1b1b1b','#666666','#e5e5e5','#ffd400','#00e0ff','#ff006a','#7cff00'];

function defaultCircle(x, y, size) {
  return { x, y, size: size||600, borderWidth: 3, borderColor: '#ffffff', borderStyle: 'solid',
           imageZoom: 100, offsetX: 0, offsetY: 0 };
}
...
const PALETTE_NAMES = ['Teal / Ember','Cobalt / Gold','Plum / Mint','Carbon / Chalk','Magenta / Cyan','Rust / Sky','Forest / Lime','Aubergine / Rose'];

window.VLOOB = { CANVAS_FONTS, FONT_LIST, WEIGHTS, COLOR_PRESETS, FRAME_PRESETS, defaultCircle, makeDefaults, PALETTES, PALETTE_NAMES };
