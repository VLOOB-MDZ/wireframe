...
const { COLOR_PRESETS } = window.VLOOB;

function Section({ title, hint, onHint, children, collapsible }) {
...
Object.assign(window, { Section, Slider, Toggle, Dropdown, Segmented, Stepper, ColorField, TextInput });
